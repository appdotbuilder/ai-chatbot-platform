...
export default function CreateChatbot({ errors }: CreateChatbotProps) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-2 text-gray-600">
                            Set up your AI-powered WhatsApp assistant to serve customers 24/7.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-2">
                        <Card className="border-0 shadow-lg">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Configure your chatbot's basic settings and identity.
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    ...
                                    <div className="border-t pt-6">
                                        ...
                                        <p className="text-gray-600 mb-6">
                                            Connect your chatbot to WhatsApp Cloud API. You can configure this later if needed.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex space-x-4 pt-6">
                                        <Button 
                                            ...
                                            className="flex-1"
                                        >
                                            {isSubmitting ? '⏳ Creating Bot...' : '🚀 Create Chatbot'}
                                        </Button>
                                        <Button 
                                            type="button" 
                                            variant="outline"
                                            onClick={() => router.get(route('chatbots.index'))}
                                            size="lg"
                                        >
                                            Cancel
                                        </Button>
                        ...
                        <Card className="border-0 shadow-md">
                            ...
                            <CardContent className="space-y-4">
                                <div className="p-3 bg-blue-50 rounded-lg">
                                    <h4 className="font-semibold text-blue-900">Choose a Clear Name</h4>
                                    <p className="text-sm text-blue-800 mt-1">
                                        Use descriptive names like "Support Bot" or "Sales Assistant"
                                    </p>
                                </div>
                                <div className="p-3 bg-green-50 rounded-lg">
                                    <h4 className="font-semibold text-green-900">WhatsApp Setup</h4>
                                    <p className="text-sm text-green-800 mt-1">
                                        You can configure WhatsApp settings later from the bot settings page
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
